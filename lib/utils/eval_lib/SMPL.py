...
class SMPL(object):
    def __init__(self,  gender='male', model_root='./models', hands=True):
        """
        Args:
        ...
        model_name = 'SMPLH' if hands else 'SMPL'
        self.model_path = osp.join(model_root, f'{model_name}_{gender}.pkl')
    ...
    def update(self, pose_axisang, betas , trans):
        ...
        pose_map = subtract_flat_id(pose_rotmat, self.hands)
        ...
        j = np.matmul(self.J_regressor, v_shaped) # 52 joints
